...
<div>
	...
	<ul>
		<li>Clears all inherited metadata from parent layouts</li>
		<li>Starts fresh with new title template</li>
		<li>Different theme color (red instead of inherited)</li>
